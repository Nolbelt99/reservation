...
namespace App\SzamlaAgent;

use App\SzamlaAgent\Document\Document;
use App\SzamlaAgent\Document\DeliveryNote;
use App\SzamlaAgent\Document\Proforma;
use App\SzamlaAgent\Document\Receipt\Receipt;
use App\SzamlaAgent\Document\Receipt\ReverseReceipt;
use App\SzamlaAgent\Document\Invoice\Invoice;
use App\SzamlaAgent\Document\Invoice\ReverseInvoice;
use App\SzamlaAgent\Document\Invoice\CorrectiveInvoice;
use App\SzamlaAgent\Document\Invoice\FinalInvoice;
use App\SzamlaAgent\Document\Invoice\PrePaymentInvoice;
use App\SzamlaAgent\Response\SzamlaAgentResponse;
use App\SzamlaAgent\Header\DocumentHeader;
...
class SzamlaAgent {
     ...
     */
    const CERTIFICATION_PATH = 'src/SzamlaAgent/Files/cert';

    /**
     * PDF dokumentumok útvonala
     */
    const PDF_FILE_SAVE_PATH = 'src/SzamlaAgent/Files/pdf';

    /**
     * XML fájlok útvonala
     */
    const XML_FILE_SAVE_PATH = 'src/SzamlaAgent/Files/xmls';

    /**
     * Fájl mellékletek útvonala
     */
    const ATTACHMENTS_SAVE_PATH = 'src/SzamlaAgent/Files/attachments';
