...
class SimplePayQuery extends Base
{
    ...
    {
        if (!isset($this->transactionBase['transactionIds']) || strlen($this->transactionBase['transactionIds']) === 0) {
    ...
    {
        if (!isset($this->transactionBase['orderRefs']) || strlen($this->transactionBase['orderRefs']) === 0) {
